    ...
    let steps = [
        {
            ...
            description:
                ": Developed a web-app which is fully responsive and open-source through which we can select our exercises according to our goals and they suggest the optimal & required number of sets of each exercises to achieve our desired physic",
        },
        {
            name: "Sorting Algo Visualizer",
            icon: "fa-solid fa-list-check",
            description:
                " Created a visual representation of sorting algorithms to understand their complexities better. It's a fun and interactive way to grasp the logic behind sorting data. Looking forward to enhancing this project with more algorithms and optimizations.",
        },
        {
            name: "Personal Finance Management App",
            icon: "fa-solid fa-diagram-project",
            description:
                "Created an Personal finance management full-stack application using Nextjs, Tailwindcss,Zod, Postgresql and Vercel to manage our finances in more convenient and reliable way.",
        },
    ];
...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Devansh</span> Mishra
                <br />Full Stack
                <span class="poppins text-violet-400">Developer</span> and
                <br />Cloud
            ...
            <p class="text-base sm:text-lg md:text-xl">
                ...
                (REACT.JS,NEXT.JS or SvelteKit),Python, TailwindCSS, Node.js + Express.js & PostgreSQL
                or Firebase/MongoDB!
                <span class="text-violet-400">and Tools </span> Cloud Platforms (AWS,Azure/GCP),OS (Linex),
                senity,ShadcnUi,MaterialUI,..etc
            </p>
            <button
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                     Gym excercise recommandation web-app with <strong
                        class="text-violet-400"
                        >React.js, TailwindCSS!</strong
                    > which is fully responsive and open-source through which we can select our exercises according to our goals and they suggest the optimal & required number of sets of each exercises to achieve our desired physic
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                    Sorting Algo Visualizer,
                    <strong class="text-violet-400">JavaScript+ Data Structures & Sorting Algorithm</strong
                    >
                    Created a visual representation of sorting algorithms to understand their complexities better. It's a fun and interactive way to grasp the logic behind sorting data. Looking forward to enhancing this project with more algorithms and optimizations.
                </p>
            </Step>
            <!-- <Step step={steps[2]}>
                <p>
                    The Poké <strong class="text-violet-400"
